...
interface Props {
  ...
  floodData: FloodRiskAssessment | null;
  assessmentData: ClimateAssessmentResult | null;
  aiInsight: AiInsightResult | null;
}

export const MobileFarmerView: React.FC<Props> = ({
  selectedLocation,
  onLocationSelect
}) => {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <div style={{ fontSize: '0.82rem', fontWeight: 800, color: '#0f172a', lineHeight: 1.15 }}>Clear</div>
                <div style={{ fontSize: '0.82rem', fontWeight: 800, color: '#0f172a', lineHeight: 1.15 }}>drainage</div>
              </div>
            ...
            <div style={{
              ...
              <div>
                <div style={{ fontSize: '0.82rem', fontWeight: 800, color: '#0f172a', lineHeight: 1.15 }}>Prepare</div>
                <div style={{ fontSize: '0.82rem', fontWeight: 800, color: '#0f172a', lineHeight: 1.15 }}>for harvest</div>
              </div>
              <div style={{ position: 'absolute', right: '0.4rem', bottom: '0.5rem', color: '#16a34a' }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M9 18l6-6-6-6"/>
            ...
            >
              ...
              <div>
                <div style={{ fontSize: '0.82rem', fontWeight: 800, color: '#0f172a', lineHeight: 1.15 }}>Buy inputs</div>
                <div style={{ fontSize: '0.82rem', fontWeight: 800, color: '#0f172a', lineHeight: 1.15 }}>before rain</div>
              </div>
              <div style={{ position: 'absolute', right: '0.4rem', bottom: '0.5rem', color: '#16a34a' }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M9 18l6-6-6-6"/>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <span style={{ fontSize: '0.88rem', fontWeight: 800, color: '#0284c7', letterSpacing: '0.03em' }}>
              ESSENTIALS TO BUY
            </span>
            <button
              onClick={() => handleMandiNav()}
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '0.45rem' }}>
            ...
            <button
              ...
              style={{
                ...
                cursor: 'pointer', boxShadow: '0 1px 3px rgba(0,0,0,0.03)', minHeight: '84px'
              }}
            >
              <svg width="28" height="28" viewBox="0 0 32 32" fill="none">
                <path d="M8 26C8 18 14 10 24 8C24 18 18 26 8 26Z" fill="#22c55e"/>
              ...
              <span style={{ fontSize: '0.78rem', fontWeight: 800, color: '#0f172a' }}>Seeds</span>
            </button>
            ...
            >
              ...
              <span style={{ fontSize: '0.78rem', fontWeight: 800, color: '#0f172a' }}>Fertilizer</span>
            </button>
            ...
            >
              ...
              <span style={{ fontSize: '0.78rem', fontWeight: 800, color: '#0f172a' }}>Pesticides</span>
            </button>
            ...
            >
              ...
              <span style={{ fontSize: '0.78rem', fontWeight: 800, color: '#0f172a' }}>Farm Tools</span>
            </button>
          </div>
        </div>
      ...
      <div style={{
        ...
        zIndex: 1000, boxShadow: '0 -2px 10px rgba(0,0,0,0.04)',
        maxWidth: '440px', margin: '0 auto'
      }}>
        <button onClick={() => navigate('/home')} style={{ background: 'none', border: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.2rem', color: '#64748b', fontSize: '0.75rem', fontWeight: 600, cursor: 'pointer' }}>
        ...
        <button onClick={() => navigate('/sih/climate-risk')} style={{ background: 'none', border: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.2rem', color: '#64748b', fontSize: '0.75rem', fontWeight: 600, cursor: 'pointer' }}>
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M12 2a10 10 0 0 1 10 10c0 5.523-4.477 10-10 10S2 17.523 2 12A10 10 0 0 1 12 2z"/>
            <path d="M12 6v12M8 10c2 0 4 2 4 4M16 10c-2 0-4 2-4 4"/>
          </svg>
          <span>Crops</span>
        </button>

        <button onClick={() => navigate('/planner')} style={{ background: 'none', border: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.2rem', color: '#16a34a', fontSize: '0.75rem', fontWeight: 800, cursor: 'pointer' }}>
      ...
      {showLocationModal && (
        <div style={{
          ...
          <div style={{
            ...
            gap: '0.85rem', boxShadow: '0 10px 25px rgba(0,0,0,0.15)'
          }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <h3 style={{ margin: 0, fontSize: '1.05rem', fontWeight: 800, color: '#0f172a' }}>Select Location</h3>
              <button onClick={() => setShowLocationModal(false)} style={{ background: 'none', border: 'none', fontSize: '1.2rem', color: '#64748b', cursor: 'pointer' }}>✕</button>
            </div>
            {['Haldia, West Bengal', 'Purba Medinipur, West Bengal', 'Burdwan, West Bengal', 'Hooghly, West Bengal'].map((preset) => (
              <button
                key={preset}
                onClick={() => { onLocationSelect({ displayName: preset, lat: 22.0667, lon: 88.0667 }); setShowLocationModal(false); }}
                style={{
                  textAlign: 'left', padding: '0.65rem 0.85rem', borderRadius: '12px',
                  border: '1px solid #e2e8f0', background: selectedLocation === preset ? '#f0fdf4' : '#f8fafc',
                  fontWeight: 700, fontSize: '0.88rem', color: selectedLocation === preset ? '#15803d' : '#334155',
