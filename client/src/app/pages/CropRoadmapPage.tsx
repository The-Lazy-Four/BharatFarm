...
import { Card, Input, Button, Spinner } from '../../components/index.js';
import { roadmapApi, CropRoadmapRequest, CropRoadmapResponse } from '../../features/roadmap/index.js';
...
export const CropRoadmapPage: React.FC = () => {
  ...
  const renderDashboard = () => {
    ...
    // Find today's and upcoming tasks
    ...
    if (todayTasks.length === 0 && allActivities.length > 0) {
      // If no exact match for today, find the most recent past task that isn't completed,
      // or the next upcoming task if we're early
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', marginTop: '1.5rem' }}>
        ...
        {error && (
          <div className="alert-danger">
            <span className="material-symbols-outlined" style={{ fontSize: '18px', marginRight: '0.5rem', verticalAlign: 'middle' }}>error</span>
            {error}
          </div>
        )}
        ...
        <div className="grid-dashboard">
          ...
          <div className="col-span-8" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            <Card title="📅 Day-wise Schedule" subtitle="Your complete farming timeline.">
          ...
          {/* Sidebar Area (Progress, Summary, Today, Upcoming) */}
